...
class QMake extends Variable
{
    ...
    public function find() : bool {
        ...
        $qtCompilerDirectory = Variables::QtCompilerDirectory()->get();
        $qmake = null;
        if ( $os === 'linux' ) $qmake = $qtCompilerDirectory . "/bin/qmake";
        else if ( $os === 'windows nt') $qmake = $qtCompilerDirectory . "/bin/qmake.exe";
        else {
    ...
    public function call() : bool {
        $qmakeProjectFile = Variables::ProjectFilename()->get();
        $compilationDirectory = Variables::CompilationDirectory()->get();
        $sourcesDirectory = Variables::SourcesDirectory()->get();
        ...
        $command = sprintf(
            ...
            $qmake,
            $sourcesDirectory . "/" . $qmakeProjectFile
        );
